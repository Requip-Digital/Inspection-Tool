...
export const MACHINE_TEMPLATES: Template[] = [
  {
    id: '1',
    name: 'Toyota',
    category: MACHINE_CATEGORIES.AIRJET,
    sections: [
      {
        id: 'general',
        name: 'General',
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'photoElectricPanelBox', name: 'photoElectricPanelBox', type: 'file', label: 'Electric Panel Box Photo', validation: { min: 1, message: 'At least one electric panel box photo is required' }},
  ...
  // RAPIER MACHINES - Picanol
  {
    id: '3',
    name: 'Picanol',
    category: MACHINE_CATEGORIES.RAPIER,
    sections: [
      {
        id: 'general',
        name: 'General',
    ...
    sections: [
      {
        ...
        fields: [
          { id: 'millMachineNo', name: 'millMachineNo', type: 'text', label: 'Mill Machine No', required: true },
          { id: 'model', name: 'model', type: 'select', label: 'Model', options: ['SM 93', 'Thema 11', 'Excel', 'Super Excel', 'Thema 11 Excel'], required: true },
          { id: 'completeModelNamePlate', name: 'completeModelNamePlate', type: 'text', label: 'Complete Model Written On Name Plate' },
          { id: 'yearOfMfg', name: 'yearOfMfg', type: 'number', label: 'Year of Manufacturing', validation: { min: 2000, max: new Date().getFullYear(), message: 'Only above 2000' } },
          { id: 'typeOfFabric', name: 'typeOfFabric', type: 'select', label: 'Type Of Fabric', options: ['Velvet', 'Carpet', 'Terry', 'Label', 'Tyre Cord', 'Denim', 'Grey', 'Yarn Dyed', 'Jacquard Fabric', 'Georget', 'Matras Sticking', 'Upholsterry', 'Kanvas', 'Net', 'Bed Sheet', 'Sarong/Sari'] },
          { id: 'workingWidth', name: 'workingWidth', type: 'select', label: 'Working Width (cm)', options: [135, 150, 170, 175, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 340, 360, 380, 400, 420, 460] },
      ...
      },
      {
        ...
        name: 'Electrical',
        fields: [
          { id: 'inverter', name: 'inverter', type: 'select', label: 'Inverter', options: ['Group', 'Individual'] },
          { id: 'photoInverter', name: 'photoInverter', type: 'file', label: 'Inverter Photo' },
          { id: 'voltage', name: 'voltage', type: 'select', label: 'Voltage', options: [200, 220, 380, 440] },
          { id: 'frequency', name: 'frequency', type: 'select', label: 'Frequency', options: [50, 60] }
        ]
      },
      {
  ...
  sections: [
    {
      ...
      fields: [
        { id: 'millMachineNo', name: 'millMachineNo', type: 'text', label: 'Mill Machine No', required: true },
        { id: 'model', name: 'model', type: 'select', label: 'Model', options: ['C401S', 'Dyna Terry', 'K88', 'Leonardo', 'Leonardo Dyna Terry', 'Leonardo HD', 'Leonardo HS', 'Leonardo Silver', 'Leonardo Silver HD', 'Leonardo Silver HS', 'P1001', 'P1001 EK', 'P1001 ES', 'P1001E', 'P401', 'P401S', 'Silver DT', 'SP1151ES'], required: true },
        { id: 'completeModelNamePlate', name: 'completeModelNamePlate', type: 'text', label: 'Complete Model Written On Name Plate' },
        { id: 'yearOfMfg', name: 'yearOfMfg', type: 'number', label: 'Year of Manufacturing', validation: { min: 1980, max: new Date().getFullYear(), message: 'Only above 1980' } },
        { id: 'typeOfFabric', name: 'typeOfFabric', type: 'select', label: 'Type Of Fabric', options: ['Velvet', 'Carpet', 'Terry', 'Label', 'Denim', 'Grey', 'Yarn Dyed', 'Jacquard Fabric'] },
        { id: 'workingWidth', name: 'workingWidth', type: 'select', label: 'Working Width (cm)', options: [ '135', '150', '170', '175', '180', '190', '200', '210', '220', '230', '240', '250', '260', '270', '280', '290', '300', '310', '320', '340', '360', '380', '400', '420', '460'] },
        { id: 'noOfColors', name: 'noOfColors', type: 'select', label: 'No Of Colors', options: [1, 2, 4, 6, 8, 10, 12] },
        { id: 'machineNameplatePhoto', name: 'machineNameplatePhoto', type: 'file', label: 'Machine Nameplate Photo', required: true }
      ]
    },
    {
      ...
      name: 'Shedding System',
      fields: [
        { id: 'sheddingMechanism', name: 'sheddingMechanism', type: 'select', label: 'Shedding Mechanism', options: ['Cam', 'Dobby', 'Crank'] },
        { id: 'sheddingMotionType', name: 'sheddingMotionType', type: 'select', label: 'Shedding Motion Type', options: ['Mechanical', 'Electronic'] },
        { id: 'sheddingMotionMake', name: 'sheddingMotionMake', type: 'select', label: 'Shedding Motion Make', options: ['Staubli', 'Fimtessile', 'Yamada'] },
        { id: 'sheddingMotionModel', name: 'sheddingMotionModel', type: 'text', label: 'Shedding Motion Model' },
        { id: 'photoSheddingMotionModel', name: 'photoSheddingMotionModel', type: 'file', label: 'Shedding Motion Model (Photo)' },
        { id: 'sheddingMotionCapacity', name: 'sheddingMotionCapacity', type: 'select', label: 'Shedding Motion Capacity (Lever)', options: [2, 4, 8, 10, 12, 16, 18, 20, 24] },
        { id: 'sheddingMotionInstalled', name: 'sheddingMotionInstalled', type: 'select', label: 'Shedding Motion Installed Capacity (Lever)', options: [2, 4, 6, 8, 9, 10, 12, 14, 16, 18, 20, 22, 24] },
        { id: 'noOfFramesSupplied', name: 'noOfFramesSupplied', type: 'number', label: 'No. of Frames Supplied', options: [2, 4, 6, 8, 10, 11, 12, 14, 16, 18, 20, 22, 24] }, 
        { id: 'photoLever', name: 'photoLever', type: 'file', label: 'Lever Photo' }
      ]
    },
    {
      ...
      name: 'Weft Insertion System',
      fields: [
        { id: 'noOfNozzles', name: 'noOfNozzles', type: 'select', label: 'No. of Nozzles', options: [2, 4, 6, 8, 10, 12] },
        { id: 'nozzlePhoto', name: 'nozzlePhoto', type: 'file', label: 'Nozzle Photo' },
        { id: 'noOfPrewinder', name: 'noOfPrewinder', type: 'select', label: 'No. of Prewinder/Set', options: [1, 2, 3, 4, 5, 6, 7, 8, 12] },
        { id: 'weftFeederPhoto', name: 'weftFeederPhoto', type: 'file', label: 'Weft Feeder Photo' },
        { id: 'weftCutterType', name: 'weftCutterType', type: 'select', label: 'Weft Cutter Type', options: ['Mechanical', 'Electronic'] }
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'beamPipeDiameter', name: 'beamPipeDiameter', type: 'text', label: 'Beam Pipe Diameter (mm)' },
        { id: 'beamPipePhoto', name: 'beamPipePhoto', type: 'file', label: 'Beam Pipe Photo' },
        { id: 'selvedgeType', name: 'selvedgeType', type: 'select', label: 'Selvedge Type', options: ['Rotary Leno', 'Tuck-in'] }
      ]
    },
    {
      id: 'warpControl',
    ...
    sections: [
      {
        ...
        fields: [
          { id: 'millMachineNo', name: 'millMachineNo', type: 'text', label: 'Mill Machine No', required: true },
          { id: 'model', name: 'model', type: 'select', label: 'Model', options: ['G 6300', 'GS 900', 'GS 920', 'GS 920F', 'GS 980'], required: true },
          { id: 'completeModelNamePlate', name: 'completeModelNamePlate', type: 'text', label: 'Complete Model Written On Name Plate' },
          { id: 'yearOfMfg', name: 'yearOfMfg', type: 'number', label: 'Year of Manufacturing', validation: { min: 2000, max: new Date().getFullYear(), message: 'Only above 2000' } },
          { id: 'typeOfFabric', name: 'typeOfFabric', type: 'select', label: 'Type Of Fabric', options: ['Velvet', 'Carpet', 'Terry', 'Label', 'Tyre Cord', 'Denim', 'Grey', 'Yarn Dyed', 'Jacquard Fabric', 'Georget', 'Matras Sticking', 'Upholsterry', 'Kanvas', 'Net', 'Bed Sheet', 'Sarong/Sari'] },
          { id: 'workingWidth', name: 'workingWidth', type: 'select', label: 'Working Width (cm)', options: [135, 150, 170, 175, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 340, 360, 380, 400, 420, 460] },
  ...
  sections: [
    {
      ...
      fields: [
        { id: 'millMachineNo', name: 'millMachineNo', type: 'text', label: 'Mill Machine No', required: true },
        { id: 'model', name: 'model', type: 'select', label: 'Model', options: ['R9500', 'R9500-2', 'R9000', 'R880'], required: true },
        { id: 'completeModelNamePlate', name: 'completeModelNamePlate', type: 'text', label: 'Complete Model Written On Name Plate' },
        { id: 'yearOfMfg', name: 'yearOfMfg', type: 'number', label: 'Year of Manufacturing', validation: { min: 2000, max: new Date().getFullYear(), message: 'Only above 2000' } },
        { id: 'typeOfFabric', name: 'typeOfFabric', type: 'select', label: 'Type Of Fabric', options: ['Denim', 'Grey', 'Yarn Dyed', 'Jacquard Fabric', 'Technical Fabrics', 'Upholstery', 'Terry'] },
        { id: 'workingWidth', name: 'workingWidth', type: 'select', label: 'Working Width (cm)', options: [190, 210, 220, 230, 260, 280, 300, 320, 340, 360, 380, 400] },
        { id: 'noOfColors', name: 'noOfColors', type: 'select', label: 'No Of Colors', options: [4, 6, 8, 12] },
        { id: 'machineNameplatePhoto', name: 'machineNameplatePhoto', type: 'file', label: 'Machine Nameplate Photo', required: true }
      ]
    },
    {
      ...
      name: 'Shedding System',
      fields: [
        { id: 'sheddingMechanism', name: 'sheddingMechanism', type: 'select', label: 'Shedding Mechanism', options: ['Cam', 'Dobby', 'Jacquard'] },
        { id: 'sheddingMotionType', name: 'sheddingMotionType', type: 'select', label: 'Shedding Motion Type', options: ['Mechanical', 'Electronic'] },
        { id: 'sheddingMotionMake', name: 'sheddingMotionMake', type: 'select', label: 'Shedding Motion Make', options: ['Staubli', 'Bonas'] },
        { id: 'sheddingMotionModel', name: 'sheddingMotionModel', type: 'text', label: 'Shedding Motion Model' },
        { id: 'photoSheddingMotionModel', name: 'photoSheddingMotionModel', type: 'file', label: 'Shedding Motion Model (Photo)' },
        { id: 'sheddingMotionCapacity', name: 'sheddingMotionCapacity', type: 'select', label: 'Shedding Motion Capacity (Lever)', options: [8, 12, 16, 20, 24] },
        { id: 'sheddingMotionInstalled', name: 'sheddingMotionInstalled', type: 'select', label: 'Shedding Motion Installed Capacity (Lever)', options: [8, 10, 12, 16, 20, 24] },
        { id: 'noOfFramesSupplied', name: 'noOfFramesSupplied', type: 'number', label: 'No. of Frames Supplied' },
        { id: 'photoLever', name: 'photoLever', type: 'file', label: 'Lever Photo' },
        { id: 'photoLeverCapacity', name: 'photoLeverCapacity', type: 'file', label: 'Lever Capacity Photo' }
      ]
    },
    {
      ...
      name: 'Weft Insertion System',
      fields: [
        { id: 'noOfPrewinder', name: 'noOfPrewinder', type: 'select', label: 'No. of Prewinder/Set', options: [4, 6, 8, 12] },
        { id: 'weftFeederMake', name: 'weftFeederMake', type: 'select', label: 'Weft Feeder Make', options: ['ROJ', 'LGL', 'Savitec'] },
        { id: 'rapierType', name: 'rapierType', type: 'select', label: 'Rapier Type', options: ['Flexible', 'Rigid'] },
        { id: 'weftStandPhoto', name: 'weftStandPhoto', type: 'file', label: 'Weft Stand Photo' },
        { id: 'weftBreakSystemPhoto', name: 'weftBreakSystemPhoto', type: 'file', label: 'Weft Break System Photo' },
        { id: 'weftFeederPhoto', name: 'weftFeederPhoto', type: 'file', label: 'Weft Feeder Photo' },
        { id: 'weftCutterType', name: 'weftCutterType', type: 'select', label: 'Weft Cutter Type', options: ['Mechanical', 'Electronic'] }
    ...
    },
    {
      ...
      fields: [
        { id: 'inverter', name: 'inverter', type: 'select', label: 'Inverter', options: ['Group', 'Individual', 'No. inverter supplied'] },
        { id: 'photoInverter', name: 'photoInverter', type: 'file', label: 'Inverter Photo' },
        { id: 'voltage', name: 'voltage', type: 'select', label: 'Voltage', options: [220, 380, 440, 560] },
        { id: 'frequency', name: 'frequency', type: 'select', label: 'Frequency', options: [50, 60] }
      ]
    },
    {
